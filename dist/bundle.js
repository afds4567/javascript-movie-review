...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"App\": () => (/* binding */ App)\n/* harmony export */ });\n/* harmony import */ var _api_keywordSearch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api/keywordSearch */ \"./src/api/keywordSearch.ts\");\n/* harmony import */ var _api_movieList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api/movieList */ \"./src/api/movieList.ts\");\n/* harmony import */ var _components_MovieItemList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/MovieItemList */ \"./src/components/MovieItemList.ts\");\n/* harmony import */ var _components_SearchBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/SearchBox */ \"./src/components/SearchBox.ts\");\n/* harmony import */ var _domain_MovieDataManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./domain/MovieDataManager */ \"./src/domain/MovieDataManager.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\nconst App = () => __awaiter(void 0, void 0, void 0, function* () {\n    var _a, _b;\n    const movieDataManager = new _domain_MovieDataManager__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n    const searchBox = new _components_SearchBox__WEBPACK_IMPORTED_MODULE_3__[\"default\"]();\n    const movieItemList = new _components_MovieItemList__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n    (_a = document.querySelector(\".logo\")) === null || _a === void 0 ? void 0 : _a.addEventListener(\"click\", () => {\n        window.location.reload();\n    });\n    document\n        .querySelector(\".search-input\")\n        .addEventListener(\"searchButtonClicked\", (e) => __awaiter(void 0, void 0, void 0, function* () {\n        if (!(e instanceof CustomEvent))\n            return;\n        document.querySelector(\"main\").innerHTML = \"\";\n        searchBox.updateKeyword(e.detail.query);\n        showMovieList();\n    }));\n    const showMovieList = () => __awaiter(void 0, void 0, void 0, function* () {\n        var _c;\n        const getData = (0,_api_keywordSearch__WEBPACK_IMPORTED_MODULE_0__.getSearchResult)();\n        const getCurrentTabResult = (keyword) => __awaiter(void 0, void 0, void 0, function* () {\n            return yield getData(keyword);\n        });\n        const movieDataManager = new _domain_MovieDataManager__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n        const { data, currentPage } = yield getCurrentTabResult(searchBox.getKeyword());\n        const result = data.results;\n        const movieElement = yield movieDataManager.generateElement(yield result, data.total_pages, currentPage);\n        const movieItemList = new _components_MovieItemList__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\n        movieItemList.addMovies(movieElement);\n        (_c = document.querySelector(\".primary\")) === null || _c === void 0 ? void 0 : _c.addEventListener(\"click\", () => __awaiter(void 0, void 0, void 0, function* () {\n            const { data, currentPage } = yield getCurrentTabResult(searchBox.getKeyword());\n            const result = data.results;\n            const movieElement = yield movieDataManager.generateElement(yield result, data.total_pages, currentPage);\n            movieItemList.addMovies(movieElement);\n        }));\n    });\n    const getData = (0,_api_movieList__WEBPACK_IMPORTED_MODULE_1__.getPopularMovie)();\n    const getCurrentTabResult = () => __awaiter(void 0, void 0, void 0, function* () {\n        return yield getData();\n    });\n    const popularMovieData = yield getCurrentTabResult();\n    const result = yield (popularMovieData === null || popularMovieData === void 0 ? void 0 : popularMovieData.data.results);\n    const movieElement = yield movieDataManager.generateElement(yield result, popularMovieData === null || popularMovieData === void 0 ? void 0 : popularMovieData.data.total_pages, popularMovieData === null || popularMovieData === void 0 ? void 0 : popularMovieData.currentPage);\n    movieItemList.addMovies(movieElement);\n    (_b = document.querySelector(\".primary\")) === null || _b === void 0 ? void 0 : _b.addEventListener(\"click\", () => __awaiter(void 0, void 0, void 0, function* () {\n        const popularMovieData = yield getCurrentTabResult();\n        const result = popularMovieData === null || popularMovieData === void 0 ? void 0 : popularMovieData.data.results;\n        const movieElement = yield movieDataManager.generateElement(yield result, popularMovieData === null || popularMovieData === void 0 ? void 0 : popularMovieData.data.total_pages, popularMovieData === null || popularMovieData === void 0 ? void 0 : popularMovieData.currentPage);\n        movieItemList.addMovies(movieElement);\n    }));\n    return;\n});\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/App.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getSearchResult\": () => (/* binding */ getSearchResult)\n/* harmony export */ });\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nconst getSearchResult = () => {\n    let currentPage = 1;\n    return function getCurrentResult(keyword) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield fetch(`https://api.themoviedb.org/3/search/movie?api_key=${\"467f40bc698d78a49a5fe841e0b0090f\"}&query=${keyword}&page=${currentPage}`);\n            const data = yield response.json();\n            currentPage += 1;\n            return { data, currentPage };\n        });\n    };\n};\nconst getData = getSearchResult();\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/api/keywordSearch.ts?");
