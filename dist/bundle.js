...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"App\": () => (/* binding */ App)\n/* harmony export */ });\n/* harmony import */ var _components_MovieItemList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/MovieItemList */ \"./src/components/MovieItemList.ts\");\n/* harmony import */ var _components_SearchBox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/SearchBox */ \"./src/components/SearchBox.ts\");\n/* harmony import */ var _domain_MovieDataManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domain/MovieDataManager */ \"./src/domain/MovieDataManager.ts\");\n/* harmony import */ var _api_keywordSearch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api/keywordSearch */ \"./src/api/keywordSearch.ts\");\n/* harmony import */ var _api_movieList__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./api/movieList */ \"./src/api/movieList.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\nconst App = () => __awaiter(void 0, void 0, void 0, function* () {\n    var _a;\n    const searchBox = (0,_components_SearchBox__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n    let popularMovieCurrentPage = 1;\n    const movieItemList = (0,_components_MovieItemList__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"POPULAR\");\n    const showPopularMovies = () => __awaiter(void 0, void 0, void 0, function* () {\n        const popularMovieData = yield (0,_api_movieList__WEBPACK_IMPORTED_MODULE_4__.getPopularMovie)(popularMovieCurrentPage);\n        if (!popularMovieData)\n            return;\n        const { results, total_pages } = popularMovieData.data;\n        const currentPage = popularMovieData.currentPage;\n        popularMovieCurrentPage = currentPage;\n        const movieElement = (0,_domain_MovieDataManager__WEBPACK_IMPORTED_MODULE_2__.generateElement)(results);\n        movieItemList.addMovies(movieElement, total_pages, popularMovieCurrentPage);\n        const moreButton = document.querySelector(\".primary\");\n        moreButton === null || moreButton === void 0 ? void 0 : moreButton.addEventListener(\"click\", showPopularMovies);\n    });\n    yield showPopularMovies();\n    const showSearchResult = () => __awaiter(void 0, void 0, void 0, function* () {\n        let searchMovieCurrentPage = 1;\n        const currentSearchMovieData = yield (0,_api_keywordSearch__WEBPACK_IMPORTED_MODULE_3__.getCurrentResult)(searchBox.getKeyword(), searchMovieCurrentPage);\n        if (!currentSearchMovieData)\n            return;\n        const { results, total_pages } = currentSearchMovieData.data;\n        searchMovieCurrentPage = currentSearchMovieData.currentPage;\n        const searchResultElement = (0,_domain_MovieDataManager__WEBPACK_IMPORTED_MODULE_2__.generateElement)(results);\n        const movieItemList = (0,_components_MovieItemList__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"SEARCH\");\n        movieItemList.addMovies(searchResultElement, total_pages, searchMovieCurrentPage);\n        const moreButton = document.querySelector(\".primary\");\n        moreButton === null || moreButton === void 0 ? void 0 : moreButton.addEventListener(\"click\", () => __awaiter(void 0, void 0, void 0, function* () {\n            const currentSearchMovieData = yield (0,_api_keywordSearch__WEBPACK_IMPORTED_MODULE_3__.getCurrentResult)(searchBox.getKeyword(), searchMovieCurrentPage);\n            if (!currentSearchMovieData)\n                return;\n            const { results } = currentSearchMovieData.data;\n            const page = currentSearchMovieData.currentPage;\n            searchMovieCurrentPage = page;\n            const searchResultElement = (0,_domain_MovieDataManager__WEBPACK_IMPORTED_MODULE_2__.generateElement)(results);\n            movieItemList.addMovies(searchResultElement, total_pages, searchMovieCurrentPage);\n        }));\n    });\n    const onSearchButtonClicked = (e) => __awaiter(void 0, void 0, void 0, function* () {\n        if (!(e instanceof CustomEvent))\n            return;\n        const mainElement = document.querySelector(\"main\");\n        if (!mainElement)\n            return;\n        mainElement.innerHTML = \"\";\n        searchBox.updateKeyword(e.detail.query);\n        yield showSearchResult();\n    });\n    (_a = document\n        .querySelector(\".search-input\")) === null || _a === void 0 ? void 0 : _a.addEventListener(\"searchButtonClicked\", onSearchButtonClicked);\n    return;\n});\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/App.ts?");
